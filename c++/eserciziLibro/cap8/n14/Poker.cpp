...
void visualizzareDeck(const int[][2], const char *[], const char *[], const int);
void valuta();
...
int main()
{
    ...
    cout << "Player1:" << endl;
    visualizzareDeck(mano, faccia, seme, player1);
    ...
    cout << "Player2:" << endl;
    visualizzareDeck(mano2, faccia, seme, player2);
    ...
    cout << "Player2:" << endl;
    visualizzareDeck(mano2, faccia, seme, player1);
...
void visualizzareDeck(const int nMano[][2], const char *nFaccia[], const char *nSeme[], const int player)
{
    for (int i = 0; i < 5; i++)
    {
        if (player == 1)
